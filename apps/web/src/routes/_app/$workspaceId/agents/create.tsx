        ...
        <div className="mt-12 text-center space-y-3 max-w-xs mx-auto relative z-20">
          ...
          >
            {steps[step].title === 'Identity'
              ...
              : steps[step].title === 'Context'
                ? 'Define who your agent represents.'
                : steps[step].title === 'Knowledge'
                  ? 'Upload docs to train your agent.'
                  : steps[step].title === 'Behavior'
                    ? 'Control how your agent handles calls.'
      ...
      <div className="p-6">
        ...
        <div className="space-y-2">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="flex items-center gap-3 p-2.5 rounded-lg border border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/30"
            >
        ...
        <div className="relative z-20 pb-12 flex justify-center gap-2">
          {steps.map((_, i) => (
            <motion.div
              ...
              style={{
                backgroundColor: i === step ? undefined : 'currentColor',
              }}
            />
          ))}
        </div>
        ...
        <header className="hidden lg:flex items-center justify-between p-8">
          <div>
            <Button
              variant="ghost"
              size="sm"
              className="pl-0 hover:pl-0 text-muted-foreground hover:text-foreground -ml-2"
            ...
            <div className="pt-2">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {step === 3 && (
                    <CallFlowStep config={config} updateConfig={updateConfig} />
                  )}
          ...
          <div className="max-w-xl mx-auto flex items-center justify-between">
            ...
            {step === steps.length - 1 ? (
              <Button
                ...
                disabled={loading}
                className="w-32 rounded-full shadow-lg shadow-primary/20"
              >
                {loading ? (
              ...
              <Button
                onClick={() => setStep((s) => s + 1)}
                className="w-32 rounded-full shadow-lg shadow-primary/20 group"
              >
                Continue

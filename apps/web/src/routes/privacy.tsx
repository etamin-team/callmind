      ...
      <div className="container max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p>
              Welcome to CallMind ("we," "our," or "us"). We are committed to protecting your personal information
              and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your
              information when you use our AI voice agent platform.
            </p>
            <p>
              By using CallMind, you agree to the collection and use of information in accordance with this policy.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Account Information:</strong> Name, email address, and password you provide when registering</li>
              <li><strong>Payment Information:</strong> Billing details processed securely through Paddle</li>
              <li><strong>Profile Information:</strong> Name, avatar, and other optional profile details</li>
            </ul>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>With Service Providers:</strong> Third-party companies that perform services on our behalf</li>
              <li><strong>With Payment Processors:</strong> Paddle processes payments securely</li>
              <li><strong>For Business Transfers:</strong> In connection with merger, sale, or transfer of assets</li>
              <li><strong>With Your Consent:</strong> With your explicit consent</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              transactions you have requested. You may request deletion of your data by contacting us.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-muted p-4 rounded-lg mt-4">
              <p><strong>Email:</strong> privacy@callmind.uz</p>

      ...
      <div className="container max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p>
              By accessing or using CallMind ("Service"), you agree to be bound
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Free Plan:</strong> 2 calls/month, 1 AI agent, basic
                features
              </li>
              <li>
                <strong>Starter Plan:</strong> $69/month, 200 calls/month, 3 AI
                agents
              </li>
              <li>
                <strong>Professional Plan:</strong> $172/month, 1,000
                calls/month, 10 AI agents
              </li>
              <li>
                <strong>Business Plan:</strong> $345/month, 2,000 calls/month,
                25 AI agents
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Payment is processed through Payme.uz</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                "Super realistic calls" are limited based on your plan tier
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              are owned by CallMind and are protected by international
              copyright, trademark, and other intellectual property laws.
            </p>
            <p>
              You retain ownership of any content you create using our AI
              agents, including call transcripts and recordings. However, you
              grant us a license to store, process, and use this data to provide
              the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              In no event shall CallMind be liable for any indirect, incidental,
          ...
          <section>
            ...
            <p>
              ...
              the laws of Uzbekistan, without regard to its conflict of law
              provisions.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-muted p-4 rounded-lg mt-4">
              <p>
                <strong>Email:</strong> legal@callmind.uz
              </p>
              <p>

...
import { Layout, Plus, Shield, TrendingUp, Zap, MessageSquare } from 'lucide-react'
import { agentTemplates } from '../../utils/mock-data'
import { AgentTemplate } from '../../types'
import { onboardingStore, updateOnboardingData, nextStep } from '../../store/onboarding-store'

    ...
    <div className="space-y-6">
        ...
        <div>
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="appointment_setter">
                Appointment Setter
              </SelectItem>
            </SelectContent>
          </Select>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="sarah_friendly">
                Sarah (Friendly, US)
              </SelectItem>
              <SelectItem value="mike_professional">
                Mike (Professional, US)
              </SelectItem>
              <SelectItem value="atlas_deep">Atlas (Deep, US)</SelectItem>
              <SelectItem value="nova_energetic">
                Nova (Energetic, UK)
              </SelectItem>
            </SelectContent>
          </Select>
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(value) => updateConfig('voiceMode', value)}
          >
            <SelectTrigger className="mt-2">
            ...
            <SelectContent>
              ...
              <SelectItem value="superRealistic">Super Realistic</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground mb-2">
          What should the agent say when answering the phone?
        </p>
        <Textarea
          id="greeting"
          rows={2}
